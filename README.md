This repository includes R program for estimating the prevalence of COVID-19 pandemic virus in the US. Data used in this repository are collected by the [COVID-19 Tracking Project](https://github.com/COVID19Tracking/covid-tracking-data). 
